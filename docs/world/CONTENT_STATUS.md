...
Fase 0 concluída. Fase 1 concluída e encerrada após auditoria editorial final aprovada. A Fase 2 está em andamento: existe 1 mundo real, `world.eldrath`, `approved`; existe 1 calendário real, `calendar.marco`, `approved`; existem 3 idiomas reais e 4 culturas fundamentais, todos `approved`; e existe 1 reino real, `kingdom.averen`, `in_review`. A cosmologia mínima e os princípios religiosos gerais foram auditados e aprovados sem reescrever a identidade existente. O contrato conceitual de geração opcional por projetos públicos do GitHub permanece concluído. Objetivos, medos, segredos, memórias, crenças, conhecimento e relações usam subregistros incorporados; eventos concretos, transmissões, grupos, hordas, ataques, incursões e demais estados atuais pertencem ao save. As quantidades existentes contam entidades reais nos arquivos de conteúdo, não menções, schemas ou templates. Todas as demais categorias continuam com quantidade existente igual a zero; tradições religiosas permanecem com quantidade existente igual a zero e `religions/` contém somente `.gitkeep`. A quantidade total planejada de culturas permanece a definir. A próxima atividade é auditar e aprovar `kingdom.averen` e então definir moeda, tesouro, fundamentos econômicos, data inicial, situação macro inicial e princípios gerais das leis comuns e mágicas.
...
- identidade geral de Eldrath: conteúdo anteriormente aprovado preservado; `world.eldrath` aprovado com a nova camada cosmológica mínima e os princípios religiosos gerais auditados;
- calendários: `calendar.marco` auditado e aprovado; quantidade existente igual a 1;
- idiomas: `language.valdren`, `language.ardren` e `language.senkar` auditados e aprovados; quantidade existente igual a 3;
- culturas: `culture.dorven`, `culture.namaru`, `culture.tessari` e `culture.ostelar` auditadas e aprovadas; quantidade existente igual a 4 e quantidade planejada a definir;
- cosmologia necessária e princípios religiosos gerais: aprovados em `world.eldrath`; nenhuma tradição religiosa concreta criada;
- reino, sistema político e sucessão: `kingdom.averen` criado e em revisão, sem ocupantes, entidades futuras ou estado atual;
- Fase 2: em andamento; próxima atividade é auditar e aprovar o reino e então criar as demais fundações macro autorizadas.
...
|---|---:|---:|---|---|---|---|---|---|
| Mundo | 1 | 1 | aprovado | contratos editoriais fundamentais | Fase 2 | `content/worlds/eldrath/world.yaml` | A identidade geral foi preservada; a cosmologia mínima e os princípios religiosos gerais foram auditados e aprovados. Data inicial e era inicial permanecem nulas; `initial_kingdom_id` referencia `kingdom.averen`. | 2026-07-16 |
| Reino | 1 | 1 | em revisão | identidade, calendário, idiomas, culturas e contratos editoriais | Fase 2 | `content/worlds/eldrath/kingdom.yaml` | `kingdom.averen`, a Coroa Pactuada de Averen, define identidade política, autoridade distribuída e sucessão completa; capital, regiões, governante, sucessor, família dinástica, facções, moeda, tesouro, métricas, leis e estado macro permanecem ausentes. | 2026-07-16 |
...
| Tradições religiosas | 3 | 0 | não iniciado | cosmologia necessária e culturas | Fases 2 e 4 | `content/worlds/eldrath/religions/` | Princípios gerais definidos sem criar doutrina concreta; schema e template concluídos; culto como organização usa `faction.*`; a pasta contém somente `.gitkeep` e nenhuma tradição foi criada. | 2026-07-16 |
...
| Calendários | a definir | 1 | aprovado | identidade geral e contratos editoriais | Fase 2 | `content/worlds/eldrath/calendars/` | `calendar.marco` define duas eras, dez períodos, seis dias semanais, cinco estações e ano fixo de 360 dias; auditoria aprovada sem alteração de sua estrutura temporal. | 2026-07-16 |
| Idiomas | a definir | 3 | aprovado | identidade geral e contratos editoriais | Fase 2 | `content/worlds/eldrath/languages/` | `language.valdren` é a língua franca viva; `language.ardren` é a língua clássica documental; `language.senkar` é a língua viva independente. Os três foram auditados entre si e aprovados; o GDD não fixa quantidade total. | 2026-07-16 |
| Culturas | a definir | 4 | aprovado | identidade, calendário e idiomas | Fase 2 | `content/worlds/eldrath/cultures/` | `culture.dorven`, `culture.namaru`, `culture.tessari` e `culture.ostelar` foram auditadas e aprovadas; não representam todas as culturas possíveis, não correspondem automaticamente às quatro regiões futuras e admitem presença multirregional e múltiplas influências por pessoa. | 2026-07-16 |
...
O estado `não iniciado` significa que a pasta foi reservada, mas não contém entidades. Existem dez entidades reais: `world.eldrath`, `calendar.marco`, `language.valdren`, `language.ardren`, `language.senkar`, `culture.dorven`, `culture.namaru`, `culture.tessari` e `culture.ostelar` estão aprovados; `kingdom.averen` está em revisão. As demais metas canônicas continuam com suas quantidades existentes registradas na tabela, sem região, assentamento, facção, religião, família, lei ou NPC criado. Schemas e templates concluídos, inclusive os de criaturas, doenças, NPCs, eventos, rumores e conflitos, não alteram essas quantidades. O contrato GitHub não cria categoria contável, não altera as contagens de Eldrath e não substitui o cenário canônico. Saúde e condições são estruturas compartilhadas; objetivos, medos, segredos, memórias, crenças, conhecimento e relações do NPC são subregistros incorporados. Hordas, ataques e incursões concretos são estado da campanha, não categorias contáveis de conteúdo inicial. Alterações posteriores devem atualizar quantidade existente, estado, documento responsável e data somente depois que o conteúdo real for criado e validado.
